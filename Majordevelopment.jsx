...
const INITIAL_SESSIONS = [
  ...
  {
    id: 3,
    title: "Churn drivers — enterprise",
    market: "APAC",
    when: "Yesterday",
  },
  {
    id: 4,
    title: "Marketing spend vs pipeline",
    market: "US",
    when: "Yesterday",
  },
  {
...
// ============================================================
// REAL BACKEND CALL
// Request goes through Express proxy
...
export default function App() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Update session title with generated dashboard title
